...
class GoCryptoMD5Test extends TestBase {

    @Test
    void test() {
        GoVerifier.verify("rules/detection/gocrypto/GoCryptoMD5TestFile.go", this);
    }
    ...
    public void asserts(
        ...
        if (findingId == 0 || findingId == 1) {
            // Both md5.New() and md5.Sum() should produce the same detection result
            /*
             * Detection Store
             */
