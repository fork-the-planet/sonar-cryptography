...
class GoCryptoRSASignPSSTest extends TestBase {
    ...
    @Test
    void test() {
        GoVerifier.verify("rules/detection/gocrypto/GoCryptoRSASignPSSTestFile.go", this);
    }
    ...
    public void asserts(
        ...
        if (findingId == 0) {
            ...
            assertsSignPSS(detectionStore, nodes);
        }
    }
    ...
    private void assertsSignPSS(
        ...
        IValue<Tree> value0 = detectionStore.getDetectionValues().get(0);
        assertThat(value0).isInstanceOf(ValueAction.class);
        assertThat(value0.asString()).isEqualTo("RSA-PSS");
