...
class GoCryptoRSASignPKCS1v15Test extends TestBase {

    public GoCryptoRSASignPKCS1v15Test() {
        super(GoCryptoRSA.rules());
    }

    @Test
    void test() {
        GoVerifier.verify("rules/detection/gocrypto/GoCryptoRSASignPKCS1v15TestFile.go", this);
    }
    ...
    public void asserts(
        ...
        if (findingId == 0) {
            ...
            assertsSignPKCS1v15(detectionStore, nodes);
        }
    }
    ...
    private void assertsSignPKCS1v15(
            @Nonnull DetectionStore<GoCheck, Tree, Symbol, GoScanContext> detectionStore,
            @Nonnull List<INode> nodes) {
        /*
         * Detection Store
        ...
        // Key tracing child (from PrivateKey -> GenerateKey depending detection)
