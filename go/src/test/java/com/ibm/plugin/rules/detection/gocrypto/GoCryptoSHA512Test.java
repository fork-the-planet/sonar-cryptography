...
class GoCryptoSHA512Test extends TestBase {

    public GoCryptoSHA512Test() {
        super(GoCryptoSHA512.rules());
    }

    @Test
    void test() {
        GoVerifier.verify("rules/detection/gocrypto/GoCryptoSHA512TestFile.go", this);
    }
