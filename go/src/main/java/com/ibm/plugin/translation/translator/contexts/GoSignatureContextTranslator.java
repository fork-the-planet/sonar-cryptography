 ...
 *
 * <p>Translates detected signature-related values to their corresponding mapper model classes.
 */
public final class GoSignatureContextTranslator implements IContextTranslation<Tree> {
