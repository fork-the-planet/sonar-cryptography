 ...
 *
 * <p>Translates detected PRNG values to their corresponding mapper model classes.
 */
public final class GoPRNGContextTranslator implements IContextTranslation<Tree> {
